    ...
    <div className="about-container" id="aboutus">
        ...
        <div className="container-1"> 
            <div className="content-class-1">
              <h1 className="au-heading">We don't like compromises, be it with the environment or the quality of our equipment.</h1>
            ...
            <img alt="ev img1" className="about-car-img-1" src="https://afdc.energy.gov/assets/images/fuels/34795_Electricity-20206e2c.jpg"/>    
        </div>
